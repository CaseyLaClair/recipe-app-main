...
const App = () => { 
    const APP_ID = '1debf8e5'; 
    const APP_KEY = '24a5fafb50d8565500ba39e12703cd2a'; 
...
`https://api.edamam.com/search?q=${search_query}&app_id=${APP_ID}&app_key=${APP_KEY}` 
    ...
    return ( 
        <div className="bg-green-50 p-6 min-h-screen font-sans"> 
            <header className="bg-green-500 rounded-2xl shadow-md py-4 text-white"> 
            ...
            <div className="container mx-auto mt-8 p-4  
                ...
                > 
                    ...
                    <button 
                        ...
                        focus:ring-green-900 text-white font-semibold py-3 px-6  
